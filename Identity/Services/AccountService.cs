...
namespace Identity.Services
{
    public class AccountService : IAccountService
    {
        ...
        public AccountService(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, SignInManager<ApplicationUser> signInManager, IOptions<JWT> jwt, IDateTimeService dateTimeService)
        {
        ...
        public async Task<Response<AuthenticationResponse>> AuthenticateAsync(AuthenticationRequest request, string ipAddress)
        {
            ...
            if (usuario == null)
            {
                throw new ApiException($"No hay una cuenta registrada con el usuario ${request.Email}.");
            }
        ...
        public async  Task<Response<string>> RegisterAsync(RegisterRequest request, string origin)
        {
            ...
            if (result.Succeeded)
            {
                await _userManager.AddToRoleAsync(usuario, Roles.Operativo.ToString());
